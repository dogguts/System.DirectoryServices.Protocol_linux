...
namespace System.DirectoryServices.Protocols
{
    ...
    public class DirectoryAttributeCollection : CollectionBase
    {
        ...
        protected override void OnValidate(object value)
        {
            ...
            {
                throw new ArgumentException(String.Format(SR.InvalidValueType, nameof(DirectoryAttribute)), nameof(value));
            }
        }
    }
    ...
    public class DirectoryAttributeModificationCollection : CollectionBase
    {
        ...
        protected override void OnValidate(object value)
        {
            ...
            {
                throw new ArgumentException(String.Format(SR.InvalidValueType, nameof(DirectoryAttributeModification)), nameof(value));
            }
        }
    }
}
