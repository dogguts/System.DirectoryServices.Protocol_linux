...
namespace System.DirectoryServices.Protocols
{
    ...
    public partial class LdapSessionOptions
    {
        ...
        //NOTE: DomainName: Moved to; LdapSessionOptions.Unix and LdapSessionOpt.Windows

        //NOTE: LocatorFlag: Moved to; LdapSessionOptions.Unix and LdapSessionOpt.Windows

        //NOTE: HostReachable: Moved to; LdapSessionOptions.Unix and LdapSessionOpt.Windows

        //NOTE: PingKeepAliveTimeout: Moved to; LdapSessionOptions.Unix and LdapSessionOpt.Windows

        //NOTE: PingLimit: Moved to; LdapSessionOptions.Unix and LdapSessionOpt.Windows

        //NOTE: PingWaitTimeout: Moved to; LdapSessionOptions.Unix and LdapSessionOpt.Windows

        //NOTE: AutoReconnect: Moved to; LdapSessionOptions.Unix and LdapSessionOpt.Windows
        ...
        //NOTE: TcpKeepAlive: Moved to; LdapSessionOptions.Unix and LdapSessionOpt.Windows


        //NOTE: candidate LDAP_OPT_TIMELIMIT; BUT !!
        // LDAP_OPT_SEND_TIMEOUT=all(?) send operations  (ps socket write)
        // LDAP_OPT_TIMELIMIT = search & bind operations
        ...
        //NOTE: FQDN: Moved to; LdapSessionOptions.Unix and LdapSessionOpt.Windows
        ...
        //NOTE: StartTransportLayerSecurity: Moved to; LdapSessionOptions.Unix and LdapSessionOpt.Windows

        //TODO: ldap_stop_tls ; not in openldap (ms specific?)
        ...
        private string GetStringValueHelper(LdapOption option, bool releasePtr)
        {
            ...
            {
                stringValue = Encoding.PtrToString(outValue);
            }
        ...
        private void SetStringValueHelper(LdapOption option, string value)
        {
            ...
            if (value != null)
            {
                inValue = Encoding.StringToHGlobal(value);
            }
        ...
        private int ProcessQueryConnection(IntPtr PrimaryConnection, IntPtr ReferralFromConnection, IntPtr NewDNPtr, string HostName, int PortNumber, SEC_WINNT_AUTH_IDENTITY_EX SecAuthIdentity, Luid CurrentUserToken, ref IntPtr ConnectionToUse)
        {
            ...
            if (_callbackRoutine.QueryForConnection != null)
            {
                ...
                {
                    NewDN = Encoding.PtrToString(NewDNPtr);
                }
